...
function getPostList(userID) {
  return new Promise((resolve, reject) =>{
     db.pool.query(`select users.user_first_name, users.user_last_name, users.user_handle, users.user_image, post_weight, post_timestamp, tmp.post_id, 
...
function getMyPostList(userID) {
  return new Promise((resolve, reject) =>{
     db.pool.query(`select users.user_first_name, users.user_last_name, users.user_handle, users.user_image, post_timestamp, posts.post_id, 
     post_title, post_content, post_image, post_likes_score, post_comment_count   
     from posts 
